...
const SubNav: React.FC<SubNavProps> = ({ selectedCategory, onCategoryClick }) => {
  ...
  return (
    <div className="sticky top-16 z-40 bg-white/90 backdrop-blur-md border-b border-blueprint-outline">
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-sm transition-colors duration-200 border ${
                  selectedCategory === 'all'
                    ...
                    : 'bg-white text-blueprint-primary border-blueprint-outline hover:border-blue-400'
                }`}
              >
                All
              </button>
